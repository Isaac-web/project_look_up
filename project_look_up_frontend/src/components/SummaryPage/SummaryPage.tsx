...
const SummaryPage: React.FunctionComponent<Props> = (props: Props) => {
  const { flightData } = props,
    ...
    fetchFlightsUrl = `${BASE_URL}/flights`,
    ordersUrl = `${BASE_URL}/orders`,
    optionsButtonRef = useRef<any>(),
    smallLoader = (
      <Loader type="BallTriangle" color="#4392F1" height={20} width={20} />
    );
  ...
  const handleOccupiedSeats = () => {
    ...
    const seats = document.querySelectorAll(
      fetchedFlight?.airplane === 'Embraer E145' ? 'rect' : 'path'
    );
  ...
  const handleSvgClick = (e: any) => {
    ...
    if (fill === '#AFAFAF') {
      ...
      newColor = '#AFAFAF';
      localChosenSeats = localChosenSeats.filter(
  ...
  const handleOrder = () => {
    ...
    if (!loginState) {
      ...
      const order: Order = {
        ...
        flightId: fetchedFlight?._id,
        numberOfPassengers: passengers,
        chosenSeats: chosenSeats,
        luggage: flightData.luggage,
        total: cost,
      };
      ...
      fetch(ordersUrl, {
        ...
        .then((res) => {
          if (res.status >= 400 && res.status < 500) {
            ...
            toast.success(
              "That's the end of the road! You just booked a flight!",
              toastProps
            );
          }
        })
  ...
  const fetchData = () => {
    ...
    fetch(fetchFlightsUrl)
      ...
      .then((response) => {
        ...
        currentFlightData = response.flights.filter(
          (flight: Flight) => flight.destination === flightData.destination
        )[0];
  ...
  const handleFetchedData = (airplaneData: Flight[]) => {
    const currentFlightData = airplaneData.filter(
      (flight) => flight.destination === flightData.destination
    )[0];

    // Calculate cost
    const luggageCost =
        flightData.luggage === 'Carry-on'
          ? 0
          : parseInt(currentFlightData.trolleyCost),
      seatsCost =
        parseInt(flightData.passengers.adults) *
          parseInt(currentFlightData.adultSeatCost) +
        parseInt(flightData.passengers.children) *
          parseInt(currentFlightData.childrenSeatCost);
        ...
        <div className="summary__options">
          <div className="summary__option">
            <div className="summary__subtitle--container">
              ...
              <h3 className="summary__subtitle">Origin</h3>
          ...
          <div className="summary__option">
            <div className="summary__subtitle--container">
              ...
              <h3 className="summary__subtitle">Destination</h3>
              <div className="underline" />
            </div>
            <p className="summary__data">
          ...
          <div className="summary__option">
            <div className="summary__subtitle--container">
              ...
              <h3 className="summary__subtitle">Departure</h3>
              <div className="underline" />
            </div>
            <p className="summary__data">
          ...
          <div className="summary__option">
            <div className="summary__subtitle--container">
              ...
              <h3 className="summary__subtitle">Time</h3>
              <div className="underline" />
            </div>
            <p className="summary__data">
          ...
          <div className="summary__option">
            <div className="summary__subtitle--container">
              ...
              <h3 className="summary__subtitle">Passengers</h3>
              <div className="underline" />
            </div>
            <p className="summary__data">
          ...
          <div className="summary__option">
            <div className="summary__subtitle--container">
              ...
              <h3 className="summary__subtitle">Luggage</h3>
              <div className="underline" />
            </div>
            <p className="summary__data">
          ...
          <div className="summary__option">
            <div className="summary__subtitle--container">
              ...
              <h3 className="summary__subtitle">Cost</h3>
              <div className="underline" />
            </div>
            <p className="summary__data">
        ...
        <div className="summary__airplane">
          {fetchState !== 'Fetched' && !fetchedFlight ? (
            ...
            <>
              ...
              <TransformWrapper>
                <TransformComponent>{renderAirplane()}</TransformComponent>
              </TransformWrapper>
            </>
          )}
        </div>
